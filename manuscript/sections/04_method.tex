...
oracle half-width is $R(t)=\operatorname{ord}_m\{|Y_c|/\sqrt{1+a_ct}\}$ and
Lemma~\ref{lem:rank} applies at the true $t$ with $\alpha_0=1-m/(K+1)$. Since
$R(t)$ is
...
monotone inversion---cheaper than the grid it replaces. An optimiser's returned
