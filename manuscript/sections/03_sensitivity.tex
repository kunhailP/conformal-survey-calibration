...
\noindent\emph{Alt text:} Two panels. Left, three descending curves on a
logarithmic horizontal axis showing the relative width cost of a loose scale
bound; the curve for the largest design share descends most slowly. Right, a
scatter of eight points of measured against predicted elasticity, all lying below
...
\midrule
budget-split dependence & \textbf{identical to $10^{-6}$}, six splits & monotone, 5\% & \textbf{passes}\\
