...
of violating it is directional and grows with simultaneity. A version of~\eqref{eq:boundary} for structured
covariance across populations, which the equal-variance closed form does not
address and which the dispersed-variance results of Section~\ref{sec:information}
show is not a small effect. And design-variance estimation that
