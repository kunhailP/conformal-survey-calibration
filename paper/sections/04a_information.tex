...
in Section~\ref{sec:applications}, that a published feasibility criterion for
this correction is a fixed population count that is~\eqref{eq:boundary}
evaluated where the correction is unnecessary. That criterion is our own
\citep{park2026wrongunit}, and the correction of it is part of the
contribution rather than a criticism of someone else.
